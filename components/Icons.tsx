...
export const FootballIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    ...
    <path d="m7.36 7.36 9.28 9.28" />
    <path d="m16.64 7.36-9.28 9.28" />
    <path d="M12 2v2.5" />
    <path d="M12 19.5V22" />
    <path d="M4.929 4.929 7 7" />
    <path d="m17 17-2.071-2.071" />
    <path d="M2 12h2.5" />
    <path d="M19.5 12H22" />
    <path d="m4.929 19.071 2.071-2.071" />
    <path d="M17 7 14.929 4.929" />
  </svg>
);
